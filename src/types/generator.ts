export type GeneratorStageType = 'QUEST_DESCRIPTION' | 'QUEST_CONSTRAINTS' | 'ACHIEVEMENT_RESOURCE_ANALYSIS' | 'MYSTERY' | 'WORLD' | 'ACHIEVEMENT_REALISATION' | 'ACHIEVEMENT_INFORMATION_FLOW' | 'ACHIEVEMENT_SCENES' | 'NPC' | 'FACTS' | 'QUEST_OUTLINE' | 'CHAPTERS' | 'SCENES' | 'QUEST_GRAPH';
