export type GeneratorStageType = 'QUEST_DESCRIPTION' | 'QUEST_CONSTRAINTS' | 'ACHIEVEMENT_RESOURCE_ANALYSIS' | 'MYSTERY' | 'WORLD' | 'ACHIEVEMENT_REALISATION' | 'ACHIEVEMENT_INFORMATION_FLOW' | 'KNOWLEDGE_CHAIN' | 'ACHIEVEMENT_SCENES' | 'ACTION_QUESTS' | 'NPC' | 'FACTS' | 'QUEST_OUTLINE' | 'CHAPTERS' | 'SCENES' | 'QUEST_GRAPH';
