export type GeneratorStageType = 'QUEST_DESCRIPTION' | 'QUEST_CONSTRAINTS' | 'MYSTERY' | 'WORLD' | 'ACHIEVEMENT_REALISATION' | 'NPC' | 'FACTS' | 'QUEST_OUTLINE' | 'CHAPTERS' | 'SCENES' | 'QUEST_GRAPH';
